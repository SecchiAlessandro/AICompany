...
### Purpose
You are a Searches the web for current developments in global health and summarizes findings.

#### Your Inputs
- Search topic: current developments in global health

#### Your Outputs
- results/health-researcher-findings.md

#### Knowledge Sources
None.

#### Tools Available
- **WebSearch** - Search the web for global health developments
...
#### Your Key Results
- **Produce a markdown summary with at least 3 relevant web search results on global health**
  Validation Criteria:
...
Find your section:
```markdown
## AGENT STATUS: health-researcher - PENDING
```
...
### Key Results:
1. [Produce a markdown summary with at least 3 relevant web search results on global health]: ACHIEVED or NOT ACHIEVED
